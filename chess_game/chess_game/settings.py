...
# The fallback is a dev-only placeholder; set CHESS_SECRET_KEY in any
# real deployment.
SECRET_KEY = os.environ.get('CHESS_SECRET_KEY', 'django-insecure-dev-only-placeholder')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('CHESS_DB_NAME', 'chess_game'),
        'USER': os.environ.get('CHESS_DB_USER', 'chess'),
        'PASSWORD': os.environ.get('CHESS_DB_PASSWORD', 'chess_dev_pw'),
        'HOST': os.environ.get('CHESS_DB_HOST', '127.0.0.1'),
        'PORT': os.environ.get('CHESS_DB_PORT', '5433'),
    }
}
